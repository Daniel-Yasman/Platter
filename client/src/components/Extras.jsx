    ...
    <div className="py-24 font-semibold text-2xl">
      ...
      <div className="flex justify-around">
        <section className="flex flex-col items-center justify-center">
          <img
            className="w-32 h-32"
            src={`${import.meta.env.VITE_API_URL}/images/pages/home/Carnivores Table Nuggets Icon.png`}
            alt="Visit our Store"
            loading="lazy"
            decoding="async"
          />
        ...
        <section className="flex flex-col items-center justify-center">
          <img
            className="w-32 h-32"
            src={`${import.meta.env.VITE_API_URL}/images/pages/home/Pizza Icon.png`}
        ...
        <section className="flex flex-col justify-center items-center">
          <img
            className="w-32 h-32"
            src={`${import.meta.env.VITE_API_URL}/images/pages/home/Cake Icon.png`}
